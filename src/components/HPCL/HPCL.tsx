...
const data = [
  ...
  },
  {
    ...
    specification: "< 2.5 ppm",
    ldl: "0.5 ppm",
  },
  {
    id: 8,
    parameter: "Phosphine",
    specification: "< 0.3 ppm",
    ldl: "0.05 ppm",
  },
  {
    id: 9,
  ...
  {
    id: 10,
    parameter: "Taste & Odour",
    specification: "No foreign taste or Odour",
    ldl: "NA",
  },
  ...
  {
    id: 13,
    parameter: "Aromatic Hydrocarbon",
    specification: "< 20 ppb",
    ldl: "1 ppb",
  },
  {
    id: 14,
    parameter: "Nitrous Fumes",
    specification: "< 2.5 ppm",
    ldl: "0.04 ppm",
  },
  {
    id: 15,
    parameter: "Carbonyl Sulfide",
    specification: "< 0.1 ppm",
    ldl: "0.0001 ppm",
  },
  {
  ...
  {
    id: 17,
    parameter: "Total Hydrocarbons (as Methane)",
    specification: "Less than 50 ppm, of which Non-Methane is less than 20 ppm",
    ldl: "0.0001 ppm",
  },
];
...
export default function HPCL() {
  return (
    <>
      <Head>
        <title>High Purity Liquid CO₂ - Rajgir Cryogenic Gases LLP</title>
      </Head>
