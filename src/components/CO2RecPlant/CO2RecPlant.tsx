  ...
  return (
    <div className="container">
      ...
      <p className="description">
        We offer CO₂ recovery plants, on turn-key basis, from distilleries, breweries and fertilizer plants.
      </p>
      <p className="description">
        Our plants are designed to consume minimum power and are Zero-Discharge plants. These plants are PLC-controlled
        with minimum manual interference. Hence, the cost of production in these plants is minimal. We have a full-fledged
